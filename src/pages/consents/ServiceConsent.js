    ...
    <div>
      ...
      <Container>
        ...
        <Box>
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>제12조(이용자의 의무)</div>
            <div style={{ fontWeight: '400' }}>
              1. 이용자는 이용자 가입을 통해 이용신청을 하는 경우 사실에
              근거하여 신청서를 작성해야 합니다. 이용자가 허위, 또는 타인의
              정보를 등록한 경우 회사에 대하여 일체의 권리를 주장할 수 없으며,
              회사는 이로 인하여 발생한 손해에 대하여 책임을 부담하지 않습니다.{' '}
              <br />
              ...
              하여서는 안 됩니다.
              <br />
              3. 이용자는 주소, 연락처, 전자우편 주소 등 회원정보가 변경된 경우
              즉시 온라인을 통해 이를 수정해야 합니다. 이 때 변경된 정보를
              수정하지 않거나 수정이 지연되어 발생하는 책임은 이용자가 지게
              됩니다. <br />
              4. 이용자는 이용자에게 부여된 명칭, 닉네임 등을 직접 관리해야
              합니다. 이용자의 관리 소홀로 발생한 문제는 회사가 책임을 부담하지
              않습니다. <br />
              5. 이용자가 아이디, 닉네임, 기타 서비스 내에서 사용되는 명칭 등을
              선정할 때에는 다음 각 호에 해당하는 행위를 해서는 안 됩니다.{' '}
              <br /> <span style={{ paddingLeft: '1.5em' }}>가.</span>
              회사가 제공하는 서비스의 공식 운영자를 사칭하거나 이와 유사한
              명칭을 사용하여 다른 이용자에게 혼란을 주는 행위 <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>나.</span> 선정적이고
              음란한 내용이 포함된 명칭을 사용하는 행위 <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>다.</span> 제3자의 상표권,
              저작권 등 권리를 침해할 가능성이 있는 명칭을 사용하는 행위 <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>라.</span>
              제3자의 명예를 훼손하거나, 그 업무를 방해할 가능성이 있는 명칭을
              사용하는 행위 <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>마.</span> 기타
              반사회적이고 관계법령에 저촉되는 내용이 포함된 명칭을 사용하는
              행위 <br />
              6. 이용자는 회사의 명시적 동의가 없는 한 서비스 이용 권한, 기타
              이용 계약 상의 지위 에 대하여 매도, 증여, 담보제공 등 처분행위를
              할 수 없습니다. <br />
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>제13조(서비스의 제공)</div>
            <div style={{ fontWeight: '400' }}>
              1. 회사의 서비스는 연중무휴, 1일 24시간 제공을 원칙으로 합니다.
              다만 회사 시스템의 유지 보수를 위한 점검, 통신장비의 교체 등
              특별한 사유가 있는 경우 서비스의 전부 또는 일부에 대하여 일시적인
              제공 중단이 발생할 수 있습니다. <br />
              2. 회사가 제공하는 개별 서비스에 대한 구체적인 안내사항은 개별
              서비스 화면에서 확인할 수 있습니다.
              <br />
              3. seedzip은 사용자가 링크, 사진, 문서 등을 한 곳에 모아보고
              효율적으로 관리 할 수 있는 플랫폼입니다. 서비스 상의 콘텐츠에 대한
              저작권 및 관련된 지적 재산권은 원저작자인 회사에게 있습니다.
              <br />
              4. 회사가 이용자에게 제공하는 서비스의 기본 내용은 다음과
              같습니다. 회사는 다음 각 호에 언급된 서비스 외에도 회사가
              개발하거나 다른 회사와의 제휴를 통해 이용자에게 신규 서비스,
              이벤트 등을 제공할 수 있습니다. <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>가.</span> 씨드 저장 및
              관리 : 이용자들이 원하는 링크, 사진, 문서를 손쉽게 저장하고,
              적절한 카테고리에 분류하며, 태그를 지정해 관리할 수 있습니다.{' '}
              <br /> <span style={{ paddingLeft: '1.5em' }}>나.</span> AI 추천
              제목, 태그, 요약 제공 : 저장된 링크, 사진, 문서에 대해 AI를
              적용하여 제목과 태그, 요약 정보를 제공함으로써 이용자들로 하여금
              손쉽게 씨드를 저장하고 찾아볼 수 있도록 돕습니다. <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>다.</span> 맞춤 필터 저장 :
              이용자들이 원하는 태그, 저장 날짜, 저장 형식, 디데이를 설정하고 그
              정보를 하나의 필터링 선택지로써 저장함으로써 더욱 정교 한 분류
              방법을 제공합니다. <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>라.</span> 기타 단체가 자체
              개발하거나 타 회사와의 협력 계약을 통해 회원들에게 제공할 일체의
              서비스
            </div>
          </Info>{' '}
          <Info>
            <div style={{ fontWeight: '600' }}>제14조(서비스의 제한 등)</div>
            <div style={{ fontWeight: '400' }}>
              1. 회사는 전시, 사변, 천재지변 또는 이에 준하는 국가비상사태가
              발생하거나 발생할 우려가 있는 경우와 전기통신사업법에 의한
              기간통신사업자가 전기통신서비스를 중지 하는 등 부득이한 사유가
              있는 경우에는 서비스의 전부 또는 일부를 제한하거나 중지 할 수
              있습니다. <br />
              ...
              4. 회사는 사전에 결제정보를 입력 받고, 무료로 제공 중인 서비스를
          ...
          <Info>
            ...
            <div style={{ fontWeight: '400' }}>
              ...
              이용자 탈퇴 신청을 동해 이용계약 해지를 요청할 수 있습니다. 단,
              신규가입 후 일정 시간 동안 서비스 부정이용 방지 등의 사유로 즉시
              탈퇴가 제한될 수 있습니다. <br />
              2. 회사는 이용자가 본 약관에서 정한 이용자의 의무를 위반한 경우 등
              비정상적인 이용 또는 부당한 이용과 이용자 금지 프로그램 사용하는
              경우 또는 타인의 명예를 훼손하거나 모욕하는 방송과 게시물을 작성한
              경우 이러한 행위를 금지하거나 삭제를 요청하였음에도 불구하고
              최초의 금지 또는 삭제 요청을 포함하여 2회 이상 누적되는 경우
              이용자에게 통지하고, 계약을 해지할 수 있습니다. <br />
              3. 회사는 이용자의 청약철회, 해제 또는 해지의 의사표시를 수신한 후
              그 사실을 이용자에게 회신합니다. 회신은 이용자가 회사에 대하여
              통지한 방법 중 하나에 동의하고, 이용자가 회사에 대하여 통지한
              연락처가 존재하지 않는 경우에는 회신하지 않을 수 있습니다.
            </div>
          </Info>{' '}
          <Info>
            <div style={{ fontWeight: '600' }}>제16조(손해배상)</div>
            <div style={{ fontWeight: '400' }}>
              1. 회사 또는 이용자는 상대방의 귀책에 따라 손해가 발생하는 경우
              손해배상을 청구할 수 있습니다. 다만, 회사는 무료서비스의 장애,
              제공 중단, 보관된 자료 멸실 또는 삭제, 변조 등으로 인한 손해에
              대하여는 배상책임을 부담하지 않습니다. <br />
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>제17조(면책사항)</div>
            <div style={{ fontWeight: '400' }}>
              1. 회사는 천재지변 또는 이에 준하는 불가항력으로 인하여 서비스를
              제공할 수 없는 경우에는 서비스 제공에 관한 책임을 지지 않습니다.
              <br />
              2. 회사는 이용자의 귀책사유로 인한 서비스 이용장애에 대하여 책임을
              지지 않습니다. 3. 회사는 이용자가 서비스를 이용하며 기대하는
              수익을 얻지 못한 것에 대하여 책임 지지 않으며 서비스를 통하여 얻은
              자료로 인한 손해 등에 대하여도 책임을 지지 않습니다. <br />
              4. 회사는 이용자가 웹페이지에 게재한 내용의 신뢰도, 정확성 등
              내용에 대해서는 책임 지지 않으며, 이용자 상호간 또는 이용자와
          ...
          <Info>
            ...
            <div style={{ fontWeight: '400' }}>
              ...
              있습니다. <br />
              2. 이용자가 수신 거부를 한 경우에도 이용약관, 개인정보보호정책,
              기타 이용자의 이익에 영향을 미칠 수 있는 중요한 사항의 변경 등
              &apos;정보통신망이용촉진 및 정보보호 등에 관한 법률&apos;에서
              정하는 사유 등 이용자가 반드시 알고 있어야 하는 사항에 대하여는
              전자우편 등의 방법으로 정보를 제공할 수 있습니다. <br />
              3. 제1항 단서에 따라 이용자가 수신 거부 조치를 취한 경우 이로
              인하여 회사가 거래 관 련 정보, 이용 문의에 대한 답변 등의 정보를
              전달하지 못한 경우 회사는 이로 인한 책임이 없습니다. <br />
              4. 회사는 &apos;정보통신망법&apos; 시행령에 따라 2년마다 영리
              목적의 광고정 정보 전송에 대한 수신동의 여부를 확인합니다. <br />
              5. 회사는 광고주의 판촉 활동에 이용자가 참여하거나, 거래의
              결과로서 발생하는 손실 또는 손해에 대하여는 책임을 지지 않습니다.
            </div>
          </Info>{' '}
          <Info>
            <div style={{ fontWeight: '600' }}>제19조(권리의 귀속)</div>
            <div style={{ fontWeight: '400' }}>
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>제20조(콘텐츠의 관리)</div>
            <div style={{ fontWeight: '400' }}>
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>제21조(콘텐츠의 저작권)</div>
            <div style={{ fontWeight: '400' }}>
              1. 이용자가 서비스 내에 게시한 콘텐츠의 저작권은 해당 콘텐츠의
              저작자에게 귀속됩니다. <br />
              2. 제1항에 불구하고 회사는 서비스의 운영, 전시, 전송, 배포, 홍보
              등의 목적으로 별도의 허락 없이 무상으로 저작권법 및 공정한
              거래관행에 합치되는 범위 내에서 다음 각 호와 같이 회원이 등록한
              콘텐츠를 사용할 수 있습니다. <br />{' '}
              <span style={{ paddingLeft: '1.5em' }}>가.</span> 서비스 내에서
              이용자가 작성한 콘텐츠의 복제, 수정, 전시, 전송, 배포 등 저작권을
              침해하지 않는 범위 내의 2차적저작물 또는 편집 저작물 작성을 위한
              사용. 다만, 해당 콘텐츠를 등록한 이용자가 해당 콘텐츠의 삭제 또는
              사용 중지를 요청하는 경우 회사는 관련 법에 따라 보존해야하는
              사항을 제 외하고 관련 콘텐츠를 모두 삭제 또는 사용중지합니다.{' '}
              <br /> <span style={{ paddingLeft: '1.5em' }}>나.</span> 서비스의
              운영, 홍보, 서비스 개선 및 새로운 서비스 개발을 위한 범위 내의
              사용
            </div>
          </Info>{' '}
          <Info>
            <div style={{ fontWeight: '600' }}>제22조(관할법원 및 준거법)</div>
            <div style={{ fontWeight: '400' }}>
          ...
          <Info>
            <div style={{ fontWeight: '600' }}>부칙</div>
          </Info>
          <Info>
            <div style={{ fontWeight: '600' }}>제1조(시행일)</div>
            <div style={{ fontWeight: '400' }}>
              본 약관은 2025.01.07.부터 시행됩니다.
            </div>
          </Info>
        </Box>
      </Container>
